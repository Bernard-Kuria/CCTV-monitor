  ...
  return (
    <div className="grid grid-cols-3 gap-5">
      {arr.map((_, index) => (
        <div
          key={index}
          className="component-border p-5 relative hover:shadow-gray-300 duration-300 min-w-[350px] text-normal grid gap-5"
        >
          ...
          <div className="technician-stats grid gap-5">
            <div className="stat-item relative">
              <div>
                Active Tasks{" "}
                <span className="absolute right-0 text-bold">2</span>
              </div>
            </div>
            <div className="stat-item relative">
              <div>

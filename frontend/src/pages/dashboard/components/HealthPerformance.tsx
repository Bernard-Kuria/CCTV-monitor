    ...
    <div>
      ...
      <div className="inline-flex flex-wrap gap-3 w-[100%]">
        ...
        <div className="online text-sm w-[350px] border p-5 flex flex-col gap-2">
          ...
          <h3 className="flex text-2xl items-center dark:text-gray-200">
            3<div className="text-red-500 shaded-texts">+2</div>
          </h3>
          <div className="text-gray-500">of 155 total cameras</div>
          <h3 className="text-gray-500 text-sm w-[100%] relative">
            Health
        ...
        <div className="online text-sm w-[350px] border p-5 flex flex-col gap-2">
          ...
          <h3 className="flex text-2xl items-center dark:text-gray-200">
            1.2s
            <div className="text-orange-500 shaded-texts">+2</div>
          </h3>
          <div className="text-gray-500">of 155 total cameras</div>
          <h3 className="text-gray-500 text-sm w-[100%] relative">
            Health
        ...
        <div className="online text-sm w-[350px] border p-5 flex flex-col gap-2">
          ...
          <h3 className="flex text-2xl items-center dark:text-gray-200">
            12
            <div className="text-red-500 shaded-texts">+2</div>
          </h3>
          <div className="text-gray-500">of 155 total cameras</div>
          <h3 className="text-gray-500 text-sm w-[100%] relative">
            Health
